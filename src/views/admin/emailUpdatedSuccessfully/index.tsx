...
const EmailUpdatedSuccessfully: React.FC = () => {
    ...
    const [ShowEmailUpdated, setShowEmailUpdated] = useState(true);
        ...
        >
            ...
            {ShowEmailUpdated && (
                <Alert status="success" variant="subtle" flexDirection="column" alignItems="center" justifyContent="center" textAlign="center" height="200px">
                    ...
                    <CloseButton position="absolute" right="8px" top="8px" onClick={() => setShowEmailUpdated(false)} />
                </Alert>
            )}
        </Flex>
    );
...
export default EmailUpdatedSuccessfully;
